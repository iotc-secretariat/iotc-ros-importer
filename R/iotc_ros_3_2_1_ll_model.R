...
ROS_3_2_1_LL_IMPORT_MODEL <-
  import_file("Ros 3.2.1 - LL", c(
    ...
    sheet("V-ATTRIBUTES", c(
      ...
      mandatory_simple_column("VESSEL_ATTRIBUTES_MAIN_ENGINE_1_MAKE", column_location("ros_common.engines", "make")), # by vessel_attributes_main_engines.main_engine_id
      mandatory_measurement_column("VESSEL_ATTRIBUTES_MAIN_ENGINE_1_POWER_VALUE", column_location("ros_common.engines", "value"), "ros_common.engines"), # by vessel_attributes_main_engines.main_engine_id
      mandatory_measurement_unit_column("VESSEL_ATTRIBUTES_MAIN_ENGINE_1_KW_HP_BHP", c("KW", "HP", "BHP")),
      optional_simple_column("VESSEL_ATTRIBUTES_MAIN_ENGINE_2_MAKE", column_location("ros_common.engines", "make")), # by vessel_attributes_main_engines.main_engine_id
      optional_measurement_column("VESSEL_ATTRIBUTES_MAIN_ENGINE_2_POWER_VALUE", column_location("ros_common.engines", "value"), "ros_common.engines"), # by vessel_attributes_main_engines.main_engine_id
    ...
    sheet("E-SET-CATCHES-SPECIMEN", c(
      ...
      # by ros_ll.specimens.depredation_detail_id (Fix me : why not using refs_biological.depredation_sources?)
    ...
    sheet("T-EVENTS", c(
      ...
      # Fix me : there is only latitude and longitude on this table...
      ...
      # Fix me : this is not linked to code-list refs_fishery.transhipment_categories
      ...
      # Fix me : not found, w<er have only here flag_code
      # by ros_common.transhipment_details.carrier_vessel_identification_id
