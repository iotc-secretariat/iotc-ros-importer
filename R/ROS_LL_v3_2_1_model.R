...
ROS_LL_v3_2_1_MODEL <-
  import_file("ROS_LL_v3_2_1", c(
    ...
    sheet("E-SET", "#[ 8] = E-SET | From row 6 - 24 columns", c(
      ...
      optional_simple_column("SETTING_OPERATIONS_SPEED_VESSEL_VALUE_KNOTS", column_location("ros_ll.setting_operations", "vessel_speed")),
      optional_simple_column("SETTING_OPERATIONS_SPEED_LINE_SETTER_VALUE_MS", column_location("ros_ll.setting_operations", "line_setter_speed")),
